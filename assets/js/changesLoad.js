...
function load(){
    content.innerHTML=sessionStorage.getItem("changes");     
}
...
function downloadHTML(){
    ...
    sHTML=sHTML.replaceAll('<script src="assets/js/changesLoad.js"></script>','');
    
    const element = document.createElement("a");
    element.setAttribute("href", "data:text/plain;charset=utf-8," + 
    encodeURIComponent(sHTML));
    element.setAttribute("download", sName+" Comparison.html");
